...
public class SettingActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            // Handle the camera action
            Intent intent = new Intent(SettingActivity.this, StampActivity.class);
            startActivity(intent);
            finish();

        } else if (id == R.id.nav_coupon) {
            // Handle the camera action
            Intent intent = new Intent(SettingActivity.this, CouponActivity.class);
            startActivity(intent);
            finish();
            ...
            // Handle the camera action
            Intent intent = new Intent(SettingActivity.this, PointActivity.class);
            startActivity(intent);
            finish();
